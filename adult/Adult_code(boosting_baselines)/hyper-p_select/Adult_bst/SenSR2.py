...
def train_nn(seed, dataset_orig_test, X_train, y_train, X_test=None, y_test=None, weights=None, n_units = [1000], lr=0.001, batch_size=1000, epoch=4000, verbose=True, activ_f = tf.nn.relu, l2_reg=0.):
    N, D = X_train.shape
